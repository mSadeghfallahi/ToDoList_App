...
from todo_app.models import Project, Task  # This imports all models and registers them with Base
...
# This ensures we use the database URL from environment variables
